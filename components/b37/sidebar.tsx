...
function SidebarRail({ className, ...props }: ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-4 z-50 hidden h-8 w-4 cursor-pointer items-center justify-center rounded-md border bg-sidebar transition-all hover:border-sidebar-accent hover:bg-sidebar-accent group-data-[side=left]:-right-2 group-data-[side=right]:-left-2 sm:flex",
        state === "collapsed"
    ...
    >
      <svg
        ...
        strokeWidth={2}
        style={{
          transform: state === "collapsed" ? "rotate(0deg)" : "rotate(180deg)",
        }}
        viewBox="0 0 24 24"
...
function SidebarContent({ className, ...props }: ComponentProps<"div">) {
  return (
    <div
      className={cn(
        "no-scrollbar flex min-h-0 flex-1 flex-col gap-2 overflow-auto transition-all duration-200 group-data-[collapsible=icon]:overflow-visible",
        className
      )}
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group-data-[collapsible=icon]:justify-center! flex w-full items-center gap-2 overflow-hidden rounded-lg p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] duration-200 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-active:font-medium data-open:hover:bg-sidebar-accent data-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:w-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>span:last-child]:group-data-[collapsible=icon]:hidden [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
