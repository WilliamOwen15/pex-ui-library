    ...
    <div className="min-h-screen bg-background">
      <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Link
            className="group rounded-lg border border-border bg-card p-6 transition-colors hover:bg-accent"
            href="/docs/components/big-number"
          >
            <div className="mb-3 flex items-center gap-3">
              <Hash className="size-5" />
              <h2 className="font-semibold text-lg">Big Number</h2>
            </div>
            <p className="text-muted-foreground text-sm">
              Display large numbers with labels and icons for dashboards and KPI
              displays
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">
              Display multiple field values side-by-side with editable and
              read-only modes, drag-and-drop reordering
            </p>
          </Link>
          ...
          >
            ...
            <p className="text-muted-foreground text-sm">
              Flexible image component with shapes, aspect ratios, sizes, and
          ...
          >
            <div className="mb-3 flex items-center gap-3">
              ...
              <h2 className="font-semibold text-lg">Video Player</h2>
            </div>
            <p className="text-muted-foreground text-sm">
              Embed YouTube videos with responsive styling or use HTML5 video
              player with customizable controls
            </p>
          </Link>
        </div>
      </main>
